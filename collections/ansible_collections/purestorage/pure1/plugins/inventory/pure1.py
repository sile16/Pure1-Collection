# Copyright (c) 2020, Matthew Robertson <mrobertson@purestorage.com>
# Copyright (c) 2020, Pure Storage Ansible Team (@sdodsley) <pure-ansible-team@purestorage.com>
...
DOCUMENTATION = '''
    ...
    options:
        plugin:
            ...
            required: True
            choices: ['purestorage.pure1.pure1']
        app_id:
...
EXAMPLES = '''
# File name must end in pure1.yml or pure1.yaml
...
# test using: ansible-inventory -i inventory_example3_pure1.yaml --graph
plugin: purestorage.pure1.pure1
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'purestorage.pure1.pure1'  # used internally by Ansible, it should match the file name but not required
